<h3>Приложение B. Список кодов поля <i>ptype</i> </h3>
<table>
<tr>
        <td><b>Число</td>
        <td><b>Тип протокола (ptype)</td>
        <td></td>
    </tr>
    <tr>
        <td>0x0800</td>
    ...
    <tr>
        <td>0x8100</td>
        <td>IEEE Std 802.1Q  - Customer VLAN Tag Type</td>
    </tr>
    <tr>
        <td>0x8808</td>
    ...
    <tr>
        <td>0x88C7</td>
        <td>IEEE Std 802.11i - Pre-Authentication</td>
    </tr>
    <tr>
        <td>0x88CC</td>
    ...
    <tr>
        <td>0x88F5</td>
        <td>IEEE Std 802.1ak - Multiple VLAN Registration Protocol</td>
    </tr>
    <tr>
        <td>0x88F6</td>
    ...
    <tr>
        <td>0x890D</td>
        <td>IEEE 802.11r     - Fast Roaming Remote Request</td>
    </tr>
</table>